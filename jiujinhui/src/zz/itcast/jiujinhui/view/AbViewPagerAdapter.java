...
public class AbViewPagerAdapter extends PagerAdapter{
	...
	/** The m list views. */
	private ArrayList<ImageView> mListViews = null;
	 ...
	 * @param mListViews2 the m list views
	 */
	public AbViewPagerAdapter(Context context,ArrayList<ImageView> mListViews2) {
